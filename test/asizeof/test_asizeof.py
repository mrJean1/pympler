...
import asizeof as asizeof  # noqa: E402 25.06.24
try:
...
class FunctionTest(unittest.TestCase):
    ...
    def test_adict(self):
        ...
        self.assertTrue(asizeof.adict(PseudoDict))
...
class AsizeofDemos(unittest.TestCase):
  ...
  ##if _opts('-gc'):  # gc examples
    ...
    def test_slots(self):
        ...
        try:  # courtesy of lor113 <https://github.com/pympler/pympler/issues/176>
            # <https://github.com/sissaschool/xmlschema/blob/master/xmlschema%2Fvalidators%2Fschemas.py>
            from xmlschema import XMLSchema10
            s = XMLSchema10("http://www.xbrl.org/2014/table.xsd")
            asizeof.asizeof(s,      stats=1)  # 1022088 CPy 3.13
            asizeof.asizeof(s.maps, stats=1)  # 1022088
        except Exception:
            pass

        # asizeof((XMLSchema10(name='table.xsd', namespace='http://xbrl.org/2014/table'),), stats=1) ...
        #  1022088 bytes or 998.1 KiB
        #        8 byte aligned
        #        8 byte sizeof(void*)
        #        1 object given
        #     6462 objects sized
        ...
        #        0 objects missed
        #     1713 duplicates
        #       59 deepest recursion
        # ...
        #
        # asizeof((XsdGlobals(validator=XMLSchema10(name....space='http://xbrl.org/2014/table')),), stats=1) ...
        #  1022088 bytes or 998.1 KiB
        #        8 byte aligned
        #        8 byte sizeof(void*)
        #        1 object given
